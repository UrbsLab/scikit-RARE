...
def Crossover_and_Mutation2(parent1_features, parent2_features, feature_list, crossover_probability, mutation_probability, 
...
def Crossover_and_Mutation(parent1_features, parent2_features, feature_list, crossover_probability, mutation_probability):
...
for i in range(0, 1000):
    ...
    offspring_list2 = Crossover_and_Mutation2(parent1_features, parent2_features, feature_list, crossover_probability, mutation_probability, bin_size_variability_constraint, max_features_per_bin)
    print(offspring_list2)
    stopsep2 = timeit.default_timer()
    
    startsep1 = timeit.default_timer()
    offspring_list1 = Crossover_and_Mutation(parent1_features, parent2_features, feature_list, crossover_probability, mutation_probability)
    print(offspring_list1)
    stopsep1 = timeit.default_timer()
    
    times.loc[i] = [stopsep1 - startsep1, stopsep2 - startsep2, len(offspring_list1[0]), len(offspring_list1[1]), len(offspring_list2[0]), len(offspring_list2[1])] 
    print(i)
